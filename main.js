...
const ZONES = [
  ...
  { id: "workspace", label: "ワークスペース", x: 0.3, y: 0.1, w: 0.25, h: 0.42, rgb: "241,196,15" },
  { id: "cafe", label: "カフェ", x: 0.61, y: 0.16, w: 0.18, h: 0.4, rgb: "230,126,34" },
  { id: "garden", label: "ガーデン", x: 0.82, y: 0.06, w: 0.16, h: 0.74, rgb: "46,204,113" },
  { id: "lounge", label: "ラウンジ", x: 0.03, y: 0.5, w: 0.24, h: 0.38, rgb: "155,89,182" },
  { id: "collab", label: "コラボレーションエリア", x: 0.32, y: 0.54, w: 0.24, h: 0.28, rgb: "26,188,156" },
  { id: "game", label: "ゲームコーナー", x: 0.58, y: 0.6, w: 0.2, h: 0.26, rgb: "231,76,60" },
];
function zoneOf(p) {
